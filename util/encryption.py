...
if __name__ == '__main__':
    encoded_JWT = jwt.encode({
        'id': 1,
        'username': 'cool'
    }, VarConfig.get()['SPATIAL_MULTIMEDIA_DB_ADMIN_PASSWORD'], algorithm='HS256')
    decoded_JWT = jwt.decode(encoded_JWT, VarConfig.get()['SPATIAL_MULTIMEDIA_DB_ADMIN_PASSWORD'], algorithms=['HS256'])
    print(encoded_JWT)
    print(decoded_JWT)
